...
func TestSampleReaderExactMultiple(t *testing.T) {
...
func TestSampleReaderPartialSample(t *testing.T) {
	...
	// Second read should return remaining 2 bytes with ErrUnexpectedEOF.
	n, err = r.Read(buf)
...
func TestSampleReaderShortBuffer(t *testing.T) {
	data := []byte{1, 2, 3, 4}
	r := newSampleReader(bytes.NewReader(data), 4)
...
func TestSampleReaderBufferNotMultiple(t *testing.T) {
...
func TestSampleReaderMultipleReads(t *testing.T) {
...
func TestSampleReaderSampleSize2(t *testing.T) {
...
func TestSampleReaderEmptyReader(t *testing.T) {
...
func TestSampleReaderBufferedData(t *testing.T) {
