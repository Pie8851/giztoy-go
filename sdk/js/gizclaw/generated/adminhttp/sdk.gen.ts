 ...
 */
export const deletePeerIcon = <ThrowOnError extends boolean = false>(options: Options<DeletePeerIconData, ThrowOnError>): RequestResult<DeletePeerIconResponses, DeletePeerIconErrors, ThrowOnError> => (options.client ?? client).delete<DeletePeerIconResponses, DeletePeerIconErrors, ThrowOnError>({ url: '/peers/{publicKey}/icon/{format}', ...options });

/**
 * Download a peer profile icon
 */
export const downloadPeerIcon = <ThrowOnError extends boolean = false>(options: Options<DownloadPeerIconData, ThrowOnError>): RequestResult<DownloadPeerIconResponses, DownloadPeerIconErrors, ThrowOnError> => (options.client ?? client).get<DownloadPeerIconResponses, DownloadPeerIconErrors, ThrowOnError>({ url: '/peers/{publicKey}/icon/{format}', ...options });

/**
 * Upload or replace a peer profile icon
 */
export const uploadPeerIcon = <ThrowOnError extends boolean = false>(options: Options<UploadPeerIconData, ThrowOnError>): RequestResult<UploadPeerIconResponses, UploadPeerIconErrors, ThrowOnError> => (options.client ?? client).put<UploadPeerIconResponses, UploadPeerIconErrors, ThrowOnError>({
    bodySerializer: null,
